        ...
        <>
            <section className="max-w-max-width mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 mb-8 sm:mb-12">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between border-b border-border-subtle pb-6">
                    <div>
                        <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-on-surface mb-2">Сравнение продуктов ANORBANK</h1>
                        <p className="text-sm text-secondary">Выберите лучшие условия для ваших финансовых целей</p>
                    </div>
                    <div className="flex items-center gap-3 sm:gap-4">
                        ...
                        {/* Показываем кнопку очистки только если есть что очищать, текст виден всегда */}
